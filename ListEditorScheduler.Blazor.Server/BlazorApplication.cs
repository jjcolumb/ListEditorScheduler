...
namespace ListEditorScheduler.Blazor.Server {
    public partial class ListEditorSchedulerBlazorApplication : BlazorApplication {
        public ListEditorSchedulerBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void ListEditorSchedulerBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
